...
public class NotifyMessageReceptionRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.mms.MessageReference message;
    ...
    public NotifyMessageReceptionRequest(
           ...
           com.roya.mas.platform.schema.mms.MessageReference message,
     ...
     * @return message
     */
    public com.roya.mas.platform.schema.mms.MessageReference getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(com.roya.mas.platform.schema.mms.MessageReference message) {
        this.message = message;
    }
