...
public class GetMessageResponse  implements java.io.Serializable {
    private com.roya.mas.platform.schema.mms.MmsMessage mmsMessage;

    public GetMessageResponse() {
    }

    public GetMessageResponse(
           com.roya.mas.platform.schema.mms.MmsMessage mmsMessage) {
     ...
     * @return mmsMessage
     */
    public com.roya.mas.platform.schema.mms.MmsMessage getMmsMessage() {
        return mmsMessage;
    }
     ...
     * @param mmsMessage
     */
    public void setMmsMessage(com.roya.mas.platform.schema.mms.MmsMessage mmsMessage) {
        this.mmsMessage = mmsMessage;
    }
