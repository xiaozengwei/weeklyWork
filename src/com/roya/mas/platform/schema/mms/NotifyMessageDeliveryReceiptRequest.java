...
package com.roya.mas.platform.schema.mms;

public class NotifyMessageDeliveryReceiptRequest  implements java.io.Serializable {
    private java.lang.String correlator;

    private com.roya.mas.platform.schema.mms.DeliveryInformation[] deliveryStatus;
    ...
    public NotifyMessageDeliveryReceiptRequest(
           ...
           com.roya.mas.platform.schema.mms.DeliveryInformation[] deliveryStatus) {
     ...
     */
    public com.roya.mas.platform.schema.mms.DeliveryInformation[] getDeliveryStatus() {
        return deliveryStatus;
    }
     ...
     */
    public void setDeliveryStatus(com.roya.mas.platform.schema.mms.DeliveryInformation[] deliveryStatus) {
        this.deliveryStatus = deliveryStatus;
    }

    public com.roya.mas.platform.schema.mms.DeliveryInformation getDeliveryStatus(int i) {
        return this.deliveryStatus[i];
    }

    public void setDeliveryStatus(int i, com.roya.mas.platform.schema.mms.DeliveryInformation _value) {
