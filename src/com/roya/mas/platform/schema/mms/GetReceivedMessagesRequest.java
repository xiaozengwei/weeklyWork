...
public class GetReceivedMessagesRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.mms.MessagePriority priority;
    ...
    public GetReceivedMessagesRequest(
           ...
           com.roya.mas.platform.schema.mms.MessagePriority priority) {
     ...
     * @return priority
     */
    public com.roya.mas.platform.schema.mms.MessagePriority getPriority() {
        return priority;
    }
     ...
     * @param priority
     */
    public void setPriority(com.roya.mas.platform.schema.mms.MessagePriority priority) {
        this.priority = priority;
    }
