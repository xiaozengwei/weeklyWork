...
package com.roya.mas.platform.schema.notification;

public class StartNotificationRequest  implements java.io.Serializable {
    private java.lang.String applicationId;

    private com.roya.mas.platform.schema.common.v2_0.MessageNotificationType[] messageNotification;
    ...
    public StartNotificationRequest(
           ...
           com.roya.mas.platform.schema.common.v2_0.MessageNotificationType[] messageNotification) {
     ...
     */
    public com.roya.mas.platform.schema.common.v2_0.MessageNotificationType[] getMessageNotification() {
        return messageNotification;
    }
     ...
     */
    public void setMessageNotification(com.roya.mas.platform.schema.common.v2_0.MessageNotificationType[] messageNotification) {
        this.messageNotification = messageNotification;
    }

    public com.roya.mas.platform.schema.common.v2_0.MessageNotificationType getMessageNotification(int i) {
        return this.messageNotification[i];
    }

    public void setMessageNotification(int i, com.roya.mas.platform.schema.common.v2_0.MessageNotificationType _value) {
