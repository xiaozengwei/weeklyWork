...
public class NotifySmsDeliveryStatusRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.sms.DeliveryInformation[] deliveryInformation;
    ...
    public NotifySmsDeliveryStatusRequest(
           ...
           com.roya.mas.platform.schema.sms.DeliveryInformation[] deliveryInformation) {
     ...
     */
    public com.roya.mas.platform.schema.sms.DeliveryInformation[] getDeliveryInformation() {
        return deliveryInformation;
    }
     ...
     */
    public void setDeliveryInformation(com.roya.mas.platform.schema.sms.DeliveryInformation[] deliveryInformation) {
        this.deliveryInformation = deliveryInformation;
    }

    public com.roya.mas.platform.schema.sms.DeliveryInformation getDeliveryInformation(int i) {
        return this.deliveryInformation[i];
    }

    public void setDeliveryInformation(int i, com.roya.mas.platform.schema.sms.DeliveryInformation _value) {
