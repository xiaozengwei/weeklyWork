...
public class NotifyPushDeliveryReceiptRequest  implements java.io.Serializable {
    ...
    public NotifyPushDeliveryReceiptRequest(
           ...
           com.roya.mas.platform.schema.wap.DeliveryInformation[] deliveryStatus) {
     ...
     */
    public com.roya.mas.platform.schema.wap.DeliveryInformation[] getDeliveryStatus() {
        return deliveryStatus;
    }
     ...
     */
    public void setDeliveryStatus(com.roya.mas.platform.schema.wap.DeliveryInformation[] deliveryStatus) {
        this.deliveryStatus = deliveryStatus;
    }

    public com.roya.mas.platform.schema.wap.DeliveryInformation getDeliveryStatus(int i) {
        return this.deliveryStatus[i];
    }

    public void setDeliveryStatus(int i, com.roya.mas.platform.schema.wap.DeliveryInformation _value) {
