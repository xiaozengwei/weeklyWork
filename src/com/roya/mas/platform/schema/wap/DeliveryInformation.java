...
public class DeliveryInformation  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.wap.DeliveryStatus status;
    ...
    public DeliveryInformation(
           ...
           com.roya.mas.platform.schema.wap.DeliveryStatus status) {
     ...
     * @return status
     */
    public com.roya.mas.platform.schema.wap.DeliveryStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.roya.mas.platform.schema.wap.DeliveryStatus status) {
        this.status = status;
    }
