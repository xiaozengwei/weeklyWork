...
public class APRegistrationRsp  implements java.io.Serializable {
    private com.roya.mas.platform.schema.ap.APRegResult regResult;
    ...
    public APRegistrationRsp(
           com.roya.mas.platform.schema.ap.APRegResult regResult,
           int nextInterval) {
     ...
     * @return regResult
     */
    public com.roya.mas.platform.schema.ap.APRegResult getRegResult() {
        return regResult;
    }
     ...
     * @param regResult
     */
    public void setRegResult(com.roya.mas.platform.schema.ap.APRegResult regResult) {
        this.regResult = regResult;
    }
