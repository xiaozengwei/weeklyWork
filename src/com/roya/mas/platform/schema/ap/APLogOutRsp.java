...
public class APLogOutRsp  implements java.io.Serializable {
    private com.roya.mas.platform.schema.ap.APLogoutResult logoutResult;

    public APLogOutRsp() {
    }

    public APLogOutRsp(
           com.roya.mas.platform.schema.ap.APLogoutResult logoutResult) {
     ...
     * @return logoutResult
     */
    public com.roya.mas.platform.schema.ap.APLogoutResult getLogoutResult() {
        return logoutResult;
    }
     ...
     * @param logoutResult
     */
    public void setLogoutResult(com.roya.mas.platform.schema.ap.APLogoutResult logoutResult) {
        this.logoutResult = logoutResult;
    }
