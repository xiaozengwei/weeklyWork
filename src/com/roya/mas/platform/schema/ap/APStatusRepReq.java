...
public class APStatusRepReq  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.ap.APStatusType APStatus;
    ...
    public APStatusRepReq(
           ...
           com.roya.mas.platform.schema.ap.APStatusType APStatus,
           int APPid) {
           this.APid = APid;
     ...
     * @return APStatus
     */
    public com.roya.mas.platform.schema.ap.APStatusType getAPStatus() {
        return APStatus;
    }
     ...
     * @param APStatus
     */
    public void setAPStatus(com.roya.mas.platform.schema.ap.APStatusType APStatus) {
        this.APStatus = APStatus;
    }
