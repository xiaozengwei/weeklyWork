...
package com.roya.mas.platform.schema.common.v2_0;

public class TimeMetric  implements java.io.Serializable {
    private com.roya.mas.platform.schema.common.v2_0.TimeMetricsValues metric;
    ...
    public TimeMetric(
           com.roya.mas.platform.schema.common.v2_0.TimeMetricsValues metric,
           int units) {
           this.metric = metric;
           this.units = units;
    }
     ...
     * @return metric
     */
    public com.roya.mas.platform.schema.common.v2_0.TimeMetricsValues getMetric() {
        return metric;
    }
     ...
     * @param metric
     */
    public void setMetric(com.roya.mas.platform.schema.common.v2_0.TimeMetricsValues metric) {
        this.metric = metric;
    }
