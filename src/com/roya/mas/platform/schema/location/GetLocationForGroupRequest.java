...
package com.roya.mas.platform.schema.location;
...
public class GetLocationForGroupRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.common.v2_0.TimeMetric maximumAge;

    private com.roya.mas.platform.schema.common.v2_0.TimeMetric responseTime;

    private com.roya.mas.platform.schema.location.DelayTolerance tolerance;

    private java.lang.String applicationId;

    private com.roya.mas.platform.schema.location.ServiceType serviceType;

    private com.roya.mas.platform.schema.location.CoordinateReferenceSystem crs;

    private com.roya.mas.platform.schema.location.LocType locType;

    private com.roya.mas.platform.schema.location.Priority prio;
    ...
    public GetLocationForGroupRequest(
           ...
           com.roya.mas.platform.schema.common.v2_0.TimeMetric maximumAge,
           com.roya.mas.platform.schema.common.v2_0.TimeMetric responseTime,
           com.roya.mas.platform.schema.location.DelayTolerance tolerance,
           java.lang.String applicationId,
           com.roya.mas.platform.schema.location.ServiceType serviceType,
           com.roya.mas.platform.schema.location.CoordinateReferenceSystem crs,
           com.roya.mas.platform.schema.location.LocType locType,
           com.roya.mas.platform.schema.location.Priority prio) {
     ...
     * @return maximumAge
     */
    public com.roya.mas.platform.schema.common.v2_0.TimeMetric getMaximumAge() {
        return maximumAge;
    }
     ...
     * @param maximumAge
     */
    public void setMaximumAge(com.roya.mas.platform.schema.common.v2_0.TimeMetric maximumAge) {
        this.maximumAge = maximumAge;
    }
     ...
     * @return responseTime
     */
    public com.roya.mas.platform.schema.common.v2_0.TimeMetric getResponseTime() {
        return responseTime;
    }
     ...
     * @param responseTime
     */
    public void setResponseTime(com.roya.mas.platform.schema.common.v2_0.TimeMetric responseTime) {
        this.responseTime = responseTime;
    }
     ...
     * @return tolerance
     */
    public com.roya.mas.platform.schema.location.DelayTolerance getTolerance() {
        return tolerance;
    }
     ...
     * @param tolerance
     */
    public void setTolerance(com.roya.mas.platform.schema.location.DelayTolerance tolerance) {
        this.tolerance = tolerance;
    }
     ...
     * @return serviceType
     */
    public com.roya.mas.platform.schema.location.ServiceType getServiceType() {
        return serviceType;
    }
     ...
     * @param serviceType
     */
    public void setServiceType(com.roya.mas.platform.schema.location.ServiceType serviceType) {
        this.serviceType = serviceType;
    }
     ...
     * @return crs
     */
    public com.roya.mas.platform.schema.location.CoordinateReferenceSystem getCrs() {
        return crs;
    }
     ...
     * @param crs
     */
    public void setCrs(com.roya.mas.platform.schema.location.CoordinateReferenceSystem crs) {
        this.crs = crs;
    }
     ...
     * @return locType
     */
    public com.roya.mas.platform.schema.location.LocType getLocType() {
        return locType;
    }
     ...
     * @param locType
     */
    public void setLocType(com.roya.mas.platform.schema.location.LocType locType) {
        this.locType = locType;
    }
     ...
     * @return prio
     */
    public com.roya.mas.platform.schema.location.Priority getPrio() {
        return prio;
    }
     ...
     * @param prio
     */
    public void setPrio(com.roya.mas.platform.schema.location.Priority prio) {
        this.prio = prio;
    }
