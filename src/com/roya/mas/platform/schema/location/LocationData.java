...
public class LocationData  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.location.RetrievalStatus reportStatus;

    private com.roya.mas.platform.schema.location.LocationInfo currentLocation;

    private com.roya.mas.platform.schema.common.v2_0.ServiceError errorInformation;
    ...
    public LocationData(
           ...
           com.roya.mas.platform.schema.location.RetrievalStatus reportStatus,
           com.roya.mas.platform.schema.location.LocationInfo currentLocation,
           com.roya.mas.platform.schema.common.v2_0.ServiceError errorInformation) {
     ...
     * @return reportStatus
     */
    public com.roya.mas.platform.schema.location.RetrievalStatus getReportStatus() {
        return reportStatus;
    }
     ...
     * @param reportStatus
     */
    public void setReportStatus(com.roya.mas.platform.schema.location.RetrievalStatus reportStatus) {
        this.reportStatus = reportStatus;
    }
     ...
     */
    public com.roya.mas.platform.schema.location.LocationInfo getCurrentLocation() {
        return currentLocation;
    }
     ...
     */
    public void setCurrentLocation(com.roya.mas.platform.schema.location.LocationInfo currentLocation) {
        this.currentLocation = currentLocation;
    }
     ...
     */
    public com.roya.mas.platform.schema.common.v2_0.ServiceError getErrorInformation() {
        return errorInformation;
    }
     ...
     */
    public void setErrorInformation(com.roya.mas.platform.schema.common.v2_0.ServiceError errorInformation) {
        this.errorInformation = errorInformation;
    }
