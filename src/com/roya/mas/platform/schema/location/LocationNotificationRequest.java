...
public class LocationNotificationRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.location.LocationData[] data;
    ...
    public LocationNotificationRequest(
           ...
           com.roya.mas.platform.schema.location.LocationData[] data) {
     ...
     * @return data
     */
    public com.roya.mas.platform.schema.location.LocationData[] getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(com.roya.mas.platform.schema.location.LocationData[] data) {
        this.data = data;
    }

    public com.roya.mas.platform.schema.location.LocationData getData(int i) {
        return this.data[i];
    }

    public void setData(int i, com.roya.mas.platform.schema.location.LocationData _value) {
        this.data[i] = _value;
    }
