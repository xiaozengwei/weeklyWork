...
public class NotifyUssdEndRequest  implements java.io.Serializable {
    ...
    private com.roya.mas.platform.schema.ussd.EndReason endReason;
    ...
    public NotifyUssdEndRequest(
           ...
           com.roya.mas.platform.schema.ussd.EndReason endReason) {
     ...
     * @return endReason
     */
    public com.roya.mas.platform.schema.ussd.EndReason getEndReason() {
        return endReason;
    }
     ...
     * @param endReason
     */
    public void setEndReason(com.roya.mas.platform.schema.ussd.EndReason endReason) {
        this.endReason = endReason;
    }
