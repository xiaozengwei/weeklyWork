...
package com.roya.mas.platform.schema.ussd;

public class UssdContinueResponse  implements java.io.Serializable {
    private com.roya.mas.platform.schema.ussd.UssdArray returnMessage;

    public UssdContinueResponse() {
    }

    public UssdContinueResponse(
           com.roya.mas.platform.schema.ussd.UssdArray returnMessage) {
     ...
     */
    public com.roya.mas.platform.schema.ussd.UssdArray getReturnMessage() {
        return returnMessage;
    }
     ...
     * @param returnMessage
     */
    public void setReturnMessage(com.roya.mas.platform.schema.ussd.UssdArray returnMessage) {
        this.returnMessage = returnMessage;
    }
