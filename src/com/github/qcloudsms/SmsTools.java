...
public class SmsTools {
	 ...
	 * 
	 */
    public  void sendSMS(String phone,String content,String ext) {
        System.out.println("开始调用短信方法-腾讯云");
        String contentSms = "【南京体育产业集团】您有一条待处理文件:"+content+" 请及时登陆OA进程处理。";
        // 短信应用SDK AppID
        int appid = 1400089991; // 1400开头
        // 短信应用SDK AppKey
        String appkey = "ca0cc135f6b0c192db0fb2a18280e2e6";
        // 需要发送短信的手机号码
        //String[] phoneNumbers = {"5996239021", "12345678902", "12345678903"};
        ...
        // 真实的模板ID需要在短信控制台中申请
        int templateId = 117218;

        // 签名
        // NOTE: 这里的签名"腾讯云"只是一个示例，
        // 真实的签名需要在短信控制台中申请，另外
        // 签名参数使用的是`签名内容`，而不是`签名ID`
        String smsSign = "南京体育产业集团";

        // 单发短信
        try {
//            SmsSingleSender ssender = new SmsSingleSender(appid, appkey);
//            SmsSingleSenderResult result = ssender.send(0, "86", phoneNumbers[0],
//"您有一件待处理公文："+content+"，请及时登陆OA办理。", "", "");
