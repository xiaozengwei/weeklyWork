...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch"  action="<%=basePath%>role/role-userlist.do" method="post" data-reloadNavtab="false">
        ...
        <div class="bjui-searchBar">
            ...
            <div class="pull-right">
            	<button type="button" class="btn-green" data-url="<%=basePath%>role/role-user-add.do?rowId=${roleRowId}"  data-toggle="dialog" data-target="role-adduser" data-id="role-input-dialog"  data-icon="plus" data-width="600" data-height="250">关联用户</button>&nbsp;
                <button type="button" class="btn-blue" data-url="<%=basePath %>role/role-removeUser.do" data-toggle="doajaxchecked" data-confirm-msg="确定要删除选中项吗？" data-icon="remove" data-idname="delids" data-group="ids"  >删除选中行</button>
            </div>
        </div>
