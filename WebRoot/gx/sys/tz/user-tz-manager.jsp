...
<div class="bjui-pageContent">
    <div style="float:left;">
        ...
        <div
            ...
            <ul id="user-manager-org-tz-tree" class="ztree" data-toggle="ztree" data-options="{nodes:'returnTreeJSON',
    ...
    <div style="margin-left:255px; height:100%;border:1px #c3ced5 solid;"  id="user-manager-user-tz-list"></div>
...
<script type="text/javascript">
    ...
    function showUsers(event, treeId, treeNode){
        ...
        $.CurrentNavtab.bjuiajax('doLoad', {url:'<%=basePath%>sysuser/user-tz-list.do', target:'#user-manager-user-tz-list',data:'bdId='+treeNode.id});
        event.preventDefault();
    }
    function returnTreeJSON() {
        var jsont ;
        $.ajax({
            url:'<%=basePath%>sysorg/org-tz-tree.do',
            type:'get',
            async:false,
            cache:false,
            dataType:'json',
