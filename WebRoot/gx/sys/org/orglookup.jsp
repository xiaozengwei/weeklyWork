...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath%>sysorg/orglookup.do" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%">
        ...
        <c:forEach items="${page.result}" var="org" varStatus="status">
            <tr>
                <td><%=count++ %></td>
                <td>${org.orgName }</td>
                <td><input type="checkbox" name="ids" data-toggle="icheck" value="{${orgId}:'${org.rowId}', ${orgName}:'${org.orgName}'}"></td>
                <td>
                    <a href="javascript:;" data-toggle="lookupback" data-args="{${orgId}:'${org.rowId}', ${orgName}:'${org.orgName}'}" class="btn btn-blue" title="选择本项" data-icon="check">选择</a>
                </td>
            </tr>
