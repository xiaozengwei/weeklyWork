...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath %>sysorg/lookup-org-list.do" method="post">
        ...
        <div class="bjui-searchBar">
            <label>组织名称：</label><input type="text" value="${param.filter_LIKES_orgName }" name="filter_LIKES_orgName" size="10" />&nbsp;
      	...
      	<c:forEach items="${page.result}" var="org" varStatus="status">
            <tr>
               ...
               <td align="center">${org.orgName}</td>
                <td><input type="checkbox" name="ids" data-toggle="icheck" value="{${orgId eq null?"parentOrgId":orgId}:'${org.rowId}',${orgId eq null?"parentOrgName":orgName}:'${org.orgName}'}"></td>
                <td>
                    <a href="javascript:;" data-toggle="lookupback" data-args="{${orgId eq null?"parentOrgId":orgId}:'${org.rowId}',${orgId eq null?"parentOrgName":orgName}:'${org.orgName}'}" class="btn btn-blue" title="选择本项" data-icon="check">选择</a>
                </td>
            </tr>
       </c:forEach>
        </tbody>
