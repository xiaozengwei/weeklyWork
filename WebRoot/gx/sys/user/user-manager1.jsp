...
<div class="bjui-pageContent">
    ...
    <div style="margin-left:255px; height:100%;border:1px #c3ced5 solid;"  id="user-manager-user-list1"></div>
...
<script type="text/javascript">
    ...
    function showUsers(event, treeId, treeNode){
        ...
        $.CurrentNavtab.bjuiajax('doLoad', {url:'<%=basePath%>sysuser/user-list1.do', target:'#user-manager-user-list1',data:'orgId='+treeNode.id});
        event.preventDefault();
    }
    function returnTreeJSON() {
        var jsont ;
        $.ajax({
            url:'<%=basePath%>sysorg/org-tree1.do',
            type:'get',
            async:false,
            cache:false,
            dataType:'json',
