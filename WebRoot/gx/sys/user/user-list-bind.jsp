...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch"  action="<%=basePath%>sysuser/user-list-bind.do" method="post">
        <input type="hidden" name="pageSize" value="${page.pageSize}">
        <input type="hidden" name="pageCurrent" value="${page.pageCurrent}">

        <div class="bjui-searchBar">
            <label>微信昵称：</label><input type="text" value="${param.filter_LIKES_nickName}" name="filter_LIKES_nickName" class="form-control" size="10">&nbsp;
            <label>姓名：</label><input type="text" value="${param.filter_LIKES_userName}" name="filter_LIKES_userName" class="form-control" size="10">&nbsp;
...
<div class="bjui-pageContent">
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tr>
            ...
            <th width="20%"  align="center">微信昵称</th>
        ...
        <c:forEach items="${page.result}" var="user" varStatus="status">
            <tr data-id="${user.rowId}">
                ...
                <td align="center">
                    <button data-url="<%=basePath%>sysuser/user-input2.do?rowId=${user.rowId}" class="btn-green" data-toggle="dialog" data-id="sysuser-update" data-width="600" data-height="400"  data-title="编辑" data-icon="edit">编辑</button>&nbsp;&nbsp;
                    <button type="button" class="btn-orange" data-url="<%=basePath%>sysuser/org-page.do?rowId=${user.rowId}"  data-toggle="dialog" data-confirm-msg="确定修改单位吗？" data-width="650" data-height="450"  data-title="修改单位" >修改单位</button >
                </td>
            </tr>
        </c:forEach>
        </tbody>
