...
<script>
    ...
    $(function () {
        var uploader = new plupload.Uploader({
            ...
            //服务器端的上传页面地址
            url : '<%=basePath%>njsfy-medicineTree/fileupload.do',
...
<div class="bjui-pageContent">
    <form action="<%=basePath%>njsfy-medicineTree/import-save.do" method="post" data-toggle="validate" data-reloadNavtab="true">
