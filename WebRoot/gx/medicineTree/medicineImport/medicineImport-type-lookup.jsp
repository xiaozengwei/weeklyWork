...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath %>njsfy-medicineImport/medicineImport-type-list.do" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%">
        ...
        <c:forEach items="${page.result}" var="column" varStatus="status">
            <tr>
                ...
                <td>
                    <a href="javascript:;" data-toggle="lookupback" data-args="{medicineParentTypeId:'${column.rowId}', medicineParentTypeName:'${column.medicineTypeName}'}" class="btn btn-blue" title="选择本项" data-icon="check">选择</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
